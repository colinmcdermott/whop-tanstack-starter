...
import { APP_NAME, APP_DESCRIPTION, PLAN_METADATA } from "../lib/constants";
...
function HomePage() {
  ...
  return (
    <main style={{ maxWidth: 900, margin: "0 auto", padding: "64px 24px", textAlign: "center" }}>
      ...
      <p style={{ fontSize: 20, color: "#71717a", marginBottom: 48 }}>{APP_DESCRIPTION}</p>
      ...
      {session ? (
        <div>
          ...
          <a href="/auth/logout" style={{ color: "#71717a", padding: "10px 24px", textDecoration: "none" }}>
            Sign out
          </a>
        </div>
      ) : (
        <a href="/auth/login" style={{ display: "inline-block", background: "#18181b", color: "white", padding: "12px 32px", borderRadius: 8, textDecoration: "none", fontWeight: 500 }}>
          Sign in with Whop
        </a>
      )}
    </main>
